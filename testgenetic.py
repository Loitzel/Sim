...
def run_genetic(population_size = 30, num_parents = 10, num_generations = 100, mutation_rate = 0.5, num_agents = 400, num_neighbors = 4, probability = 0.2, objective_function = notified_function, num_constant_bests = 1):
